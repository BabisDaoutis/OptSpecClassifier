...
def rf_classify_mc_spectra(wavelength, flux, sigma, plot=False, classify_AGN_type=False, n_mc=100, clf=clf, scaler_sv=scaler_sv):
    """`
    ...
    classify_AGN_type : bool, if this flag is true, the function will further classify AGN types (NLAGN vs BLAGN) based on
        the FWQM of H-alpha using a separate classifier. Default is False.
    plot : bool
    ...
    if classify_AGN_type and majority_class == "AGN":
    ...
    if plot:
        ...
        return majority_class, mean_probabilities, std_probabilities, AGN_type
